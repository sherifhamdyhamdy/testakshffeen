...
public class CompanyBean implements java.io.Serializable {
	...
	private InsuranceCompanyBean inBean;
	...
	public CompanyBean(DistricBean distric, UnitBean unit) {
		this.distric = distric;
		this.unit = unit;
	}

	public CompanyBean(DistricBean distric, UnitBean unit, String nameAr,
	...
	public InsuranceCompanyBean getInBean() {
		return inBean;
	}

	public void setInBean(InsuranceCompanyBean inBean) {
		this.inBean = inBean;
	}
}
