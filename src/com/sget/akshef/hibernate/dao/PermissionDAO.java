...
import com.sget.akshef.hibernate.entities.PermissionEntity;
...
public class PermissionDAO {
    ...
    public boolean delete(PermissionEntity entity) {
    ...
    public List<PermissionEntity> getAll() {
        List<PermissionEntity> entities = null;
        try {
            Query query = hiber.getSession().createSQLQuery("SELECT permission.* FROM permission permission ")
                    .addEntity("role.", PermissionEntity.class);
            entities = query.list();
    ...
    public PermissionEntity getById(int id) {
        ...
        try {
        	entity = (PermissionEntity) hiber.getSession().get(PermissionEntity.class, id);
