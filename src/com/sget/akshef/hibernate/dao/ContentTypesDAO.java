...
public class ContentTypesDAO {
	...
	public void insert(ContentTypesEntity entity){
		try{
	...
	public boolean update(ContentTypesEntity entity) {
        if(entity == null)
        	return false;
		try {
    ...
    public boolean delete(ContentTypesEntity entity) {
    ...
    public List<ContentTypesEntity> getAll() {
        List<ContentTypesEntity> entities = null;
        try {
            Query query = hiber.getSession().createSQLQuery("SELECT content_types.* FROM content_types content_types ")
                    .addEntity("content_types.", ContentTypesEntity.class);
            entities = query.list();
    ...
    public ContentTypesEntity getById(int id) {
        if(id < 1)
        	return null ;
        
    	ContentTypesEntity entity = null;
        try {
            entity = (ContentTypesEntity) hiber.getSession().get(ContentTypesEntity.class, id);
