...
public class TipsContent extends AdminControl implements Serializable{

	private static final long serialVersionUID = 1384614297991653742L;
	...
	public TipsContent(){
		...
		//if(categories != null && categories.size() > 0)
			//contents = service.getContentByBranchAndType(DBConstants.CONTENT_TYPE_TIPS, categories.get(0).getId(), branchId);
	}
	/**
	...
	public void populateContentDetails(){
		if(category > 0){
			//contents = service.getContentByBranchAndType(DBConstants.CONTENT_TYPE_TIPS, category, branchId);
